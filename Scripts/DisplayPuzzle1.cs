...
public class DisplayPuzzle1 : MonoBehaviour
{
    ...
    public GameObject ConnectingPuzzle, connectingDoor;
    ...
    public void HandleMessage(string ButtonName)
    {
        ...
        if (ButtonValue > 0 && ButtonValue < 5)
        {
            displayableObjects[currentObject].GetComponent<SpriteRenderer>().sprite = availablePictures[ButtonValue - 1];
            currentObject += 1;
        }
